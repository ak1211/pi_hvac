...
import InfraredRemote.Code (InfraredHexString)
...
-- | 測定値型
newtype MeasEnvironment = MeasEnvironment
  { id            :: Int
  , degc          :: Number
  , hpa           :: Number
...
-- |
newtype RespGetI2cDevices = RespGetI2cDevices
  { data :: Array Int
  }
...
-- | 赤外線コードAPI型
newtype DatumInfraRed = DatumInfraRed
  { button_number :: Int
...
-- |
newtype RespGetIrdbManufacturers = RespGetIrdbManufacturers
