...
render state = case state.route of
  Route.Home -> HH.slot _pgHome unit PgHome.component unit absurd
  Route.Plotdata _ -> HH.slot _pgPlotdata unit PgPlotdata.component state.route absurd
  Route.Infrared _ -> HH.slot _pgInfrared unit PgInfrared.component state.route absurd
  Route.Settings -> HH.slot _pgSettings unit PgSettings.component unit absurd
  Route.About -> HH.slot _pgAbout unit PgAbout.component unit absurd
...
routeSignal hio interface = H.liftEffect $ PushState.matches Route.routing pathChanged interface
  where
